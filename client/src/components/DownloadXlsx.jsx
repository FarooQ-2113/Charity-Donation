...
const ExportXlsx = () => {
  ...
  const handleOnExport = () => {
    ...
    // append sheet to workbook and name CharityDonationSummary
    XLSX.utils.book_append_sheet(wb, ws, "CharityDonationSummary");
    
    // write xlsx file for download
    XLSX.writeFile(wb, "CharityDonationSummary.xlsx");
  };
